                        ...
                        <div className="input-group justify-content-end p-3">
                              <div className="form-outline">
                                    <input onChange={(e) => handleSearchText(e)} type="search"
                                          value={searchText}
                                          style={{ width: '300px' }}
                                          id="form1" className="form-control" placeholder='Tên, số điện thoại, địa chỉ' />
                              </div>
                        ...
                        <table className="table table-hover">
                              <thead>
                                    <tr className="d-flex ">
                                          ...
                                          <th className="col-1 d-flex justify-content-center align-items-center  ">Đổi trạng thái</th>
                                    </tr>
                              </thead>
                              <tbody>
                                    {data.length > 0 ?
                                                ...
                                                return (
                                                      ...
                                                      <tr key={index} className="d-flex ">
                                                            ...
                                                            <td className="col-1 d-flex justify-content-center align-items-center   " >
                                                                  <Popup userName={order.user?.name}
...
const Popup = ({ userName, orderId, status, parentCallback }) => {
